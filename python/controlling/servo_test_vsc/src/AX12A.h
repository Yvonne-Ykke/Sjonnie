...
private:
	...
	unsigned char Direction_Pin_TR;
...
public:
	void begin(long baud, unsigned char directionPinTX, unsigned char directionPinRX, unsigned char directionPinTR, HardwareSerial *srl);
	void end(void);
